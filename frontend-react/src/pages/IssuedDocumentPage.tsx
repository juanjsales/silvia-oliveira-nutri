...
const clinicalFieldLabels: Record<string, string> = {
  ...
  arm: 'Circunferência do braço direito',
  armLeft: 'Circunferência do braço esquerdo',
  forearmRight: 'Circunferência do antebraço direito',
  forearmLeft: 'Circunferência do antebraço esquerdo',
  ...
  thighRight: 'Circunferência da coxa direita',
  thighLeft: 'Circunferência da coxa esquerda',
  calf: 'Circunferência da panturrilha direita',
  calfLeft: 'Circunferência da panturrilha esquerda',
