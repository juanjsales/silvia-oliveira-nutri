...
export function PatientPlanPage(){
 ...
 const meals=plan.content.meals||plan.content.refeicoes||[],visibility=plan.content.patientVisibility||'SUMMARY',showDetails=visibility!=='HIDDEN',showNutrition=visibility==='FULL';
